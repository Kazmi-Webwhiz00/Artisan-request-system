...
/**
 * Render a Bootstrap-styled text field with prefixed classes for uniqueness
 *
 ...
 */
function render_text_field($name, $id, $label = '', $placeholder = '', $value = '', $required = false, $additional_attrs = []) {
    // Start rendering
    ...
    // Add input field
    $field .= '<input type="text" class="form-control" name="' . esc_attr($name) . '" id="' . esc_attr($id) . '"';
    if ($placeholder) {
